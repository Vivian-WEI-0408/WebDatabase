            ...
            for each_feature in self.EnzymeList:
                ...
                for each_index in EnzymeInfo['index']:
                    ...
                    if(self.sequence[each_index-8:each_index-2].upper() == "CGTCTC"):
                        ...
                        file.write(f"     misc_feature    {each_index-1}..{each_index+3}\n")
                    ...
                    #AarI forward
                    elif(self.sequence[each_index-11:each_index-5].upper() == "CACCTGC"):
                        file.write(f"     misc_feature    {each_index+4}..{each_index+10}\n")
                        file.write(f"                     /label={EnzymeName} Site\n")
                        file.write(f"     misc_feature    {each_index-1}..{each_index+3}\n")
                        file.write(f"                     /label={EnzymeScarName[NameIndex]} Scar\n")
                    ...
                    #AarI reverse
                    elif(self.sequence[each_index+8:each_index+15].upper() == "GCAGGTG"):
                        file.write(f"     misc_feature    {each_index+4}..{each_index+10}\n")
                        file.write(f"                     /label={EnzymeName} Site\n")
                        file.write(f"     misc_feature    {each_index-1}..{each_index+3}\n")
                        file.write(f"                     /label={EnzymeScarName[NameIndex]} Scar\n")
                    ...
                    #SapI reverse
                    elif(self.sequence[each_index+4:each_index+11].upper() == "GAAGAGC"):
                        file.write(f"     misc_feature    {each_index+4}..{each_index+10}\n")
                        file.write(f"                     /label={EnzymeName} Site\n")
                        file.write(f"     misc_feature    {each_index-1}..{each_index+3}\n")
                        file.write(f"                     /label={EnzymeScarName[NameIndex]} Scar\n")
